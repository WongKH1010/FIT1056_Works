...
def backup_data(data_path=os.path.dirname(__file__), backup_dir=os.path.dirname(__file__)):
    data_path = os.path.join(data_path, '..', 'data', 'msms.json')
    backup_dir = os.path.join(backup_dir, '..', 'data', 'backups')
